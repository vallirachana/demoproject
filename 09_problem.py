...
class TestSearchLinkedList(unittest.TestCase):
    ...
    def test_02(self):
        node = llists.create_from_string('{val:"arun",next:{val:"babu",next:{val:"john",next:{val:"kavya",next:{val:"raheem",next:{val:"surya",next:None}}}}}}')
    ...
    def test_04(self):
        node = llists.create_from_string('{val:"arun",next:{val:"arun madhav",next:{val:"john",next:{val:"kavya",next:{val:"raheem",next:{val:"surya",next:None}}}}}}')
